...
export const SIMULATIONS = [
    ...
    { id: 'neo-watch', href: 'neo-watch.html', title: 'Near-Earth Watch',
      category: 'earth-orbit', group: 'orbital-ops',
      tier: 'public', icon: 'target', badge: 'NEW',
      blurb: 'Everything catalogued around Earth right now, propagated live from JPL elements.' },
    ...
    { id: 'star-collider', href: 'star-collider.html', title: 'Star Collider Lab',
      category: 'deep-space', group: 'black-holes',
      tier: 'public', icon: 'collider', badge: 'NEW',
